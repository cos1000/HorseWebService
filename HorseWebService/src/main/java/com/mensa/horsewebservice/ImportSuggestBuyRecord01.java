 ...
 * @author matt_
 */
public class ImportSuggestBuyRecord01 {
    ...
    private final String category = "Matt_suggest_01";
                            ...
                            if (record.getResults().getCRS() != null) {
                                ...
                                if ("RFD".equals(record.getResults().getCRS())) {
                                    ...
                                    if (result.compareTo(highDefine1) > 0) {
                                        ...
                                        suggestBuyRecord.setWinPrice(basePrice.multiply(suggestBuyRecord.getOdds()).subtract(basePrice).divide(new BigDecimal("2")));
